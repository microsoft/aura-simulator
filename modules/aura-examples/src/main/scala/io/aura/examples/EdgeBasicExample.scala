...
/** Edge computing example with latency-aware offloading.
  *
  * Demonstrates a 3-tier edge topology (Device -> EdgeMicro -> Cloud) with 20 sensor tasks offloaded using latencyAware
  * policy.
  */
object EdgeBasicExample:
  def main(args: Array[String]): Unit =

    println("=" * 70)
    println("Aura Cloud Simulator - Edge Computing (Latency Aware)")
    println("=" * 70)

    val config = simulation("edge-basic", endTime = SimTime(100.0)) {
